...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR,
        _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_TRNS, _______,          _______,
